...
BEGIN
  ...
  -- 0. CLEANUP (Force cascading cleanup before starting)
  ...
  -- Profiles (ON CONFLICT handles trigger overlap)
  ...
  ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, phone = EXCLUDED.phone, role = EXCLUDED.role, location = EXCLUDED.location, is_verified = EXCLUDED.is_verified;
  ...
  ON CONFLICT (id) DO UPDATE SET hospital_name = EXCLUDED.hospital_name, license_number = EXCLUDED.license_number, status = EXCLUDED.status, verified_at = EXCLUDED.verified_at;
  ...
  ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, phone = EXCLUDED.phone, role = EXCLUDED.role, location = EXCLUDED.location;
  ...
  ON CONFLICT (id) DO UPDATE SET blood_group = EXCLUDED.blood_group, points = EXCLUDED.points, total_donations = EXCLUDED.total_donations;
  ...
  ON CONFLICT (id) DO UPDATE SET emergency_contact = EXCLUDED.emergency_contact;
